...
from consts import add_meeting_admin_db_path
...
# JUST DIALOG ==========================================================================================================
                    if check_just_dialog(user_id, main_db_path):
...
# IN ADD MEETING - REQUEST =============================================================================================
                    elif check_param(user_id, "in_add_meeting", main_db_path):
                        response = add_meeting_request(user_id, body)
                        if response['exit']:
                            back_just_dialog(user_id, main_db_path)
                        send_message(user_id, response['message'],
...
# IN ADD MEETING - RESPONSE ============================================================================================
                    elif user_id == vk_id_admin and check_param(user_id, "new_users", add_meeting_admin_db_path):
                        pass
# STOPPING BOT =========================================================================================================
